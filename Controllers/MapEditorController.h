...
public:
  ...
  */
    ...
    /**
     * Load the content of a chest from a file and store it inside of the chestToFill parameter
     * @param chestToFill the chest that we want to fill with the stored one
     * @param filename the name of the file that contains the chest
     */
    void loadChest(Chest &chestToFill, const std::string &filename);
